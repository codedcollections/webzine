...
export default function Article({blok}) {
  ...
  return(
    <article {...storyblokEditable(blok)} className="max-w-3xl mx-auto my-10 px-8 py-10 bg-slate-50 border border-slate-200 rounded-xl shadow-sm">
      <p>
        <Link href="/articles"
    ...
    <div className="flex items-center gap-4 gap-3 mt-6 px-4 py-3 bg-slate-100 border-l-4 border-blue-600 rounded-md text-slate-700">
